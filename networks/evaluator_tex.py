...
from util.surface_depth import *
...
class EvaluatorTex(object):
    ...
    def run_Secant_method(self, img, vol, f_low, f_high, z_low, z_high,n_secant_steps, sampled_rays_d_world, view_diff):
    ...
    def run_Bisection_method(self, img, vol, z_low, z_high, n_secant_steps, sampled_rays_d_world,
                          view_diff):
